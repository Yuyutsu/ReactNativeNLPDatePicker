# NLPCalendar — Expo Example

A runnable [Expo](https://expo.dev) application that demonstrates the `react-native-nlp-calendar` package. No native toolchain required — works on iOS, Android, and web via **Expo Go**.
